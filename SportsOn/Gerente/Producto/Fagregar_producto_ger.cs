...
{
    public partial class Fagregar_producto_ger : Form
    {
        public Fagregar_producto_ger()
        {
            InitializeComponent();
        ...
        private void Fagregar_producto_ger_Load(object sender, EventArgs e)
        {
        ...
        private void editarProducto_Click_1(object sender, EventArgs e)
        {
            DialogResult resultado = MessageBox.Show("Seguro que desea editar el producto?", "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (resultado == DialogResult.Yes)
            {
